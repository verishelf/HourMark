...
export const MOCK_LISTINGS: Listing[] = [
  {
    ...
    ai_trust_score: 88,
    trust_badges: ["verified_seller", "ai_authenticated", "escrow_protected", "full_set"],
    fraud_flags: [],
    includes_box: true,
    includes_papers: true,
    includes_warranty_card: true,
  ...
  },
  {
    ...
    price: 5200000,
    description:
      "Iconic Royal Oak 41mm in stainless steel with blue Grande Tapisserie dial. Watch only.",
    images: [
