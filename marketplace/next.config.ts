...
if (!process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY && process.env.EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY) {
  process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY = normalize(
